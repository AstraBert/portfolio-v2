...
export function generateMetadata() {
    return {
        title: "Projects - Clelia",
        description: "Here are some of my projects that I have worked on: I am an open-source advocate, I try to build real solutions to everyday problems, I love automation and I try to apply AI, ML, and DevOps to my projects.",
        openGraph: {
