...
export { supabase, bioinformatics, shellscript, transformers, git, postgresssql, scikitlearn, fastapi, qdrant, github, react, vercel, docker, python, jekyll, typescript };
